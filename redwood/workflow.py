    ...
    if not args.dry_run:
        ...
        if not args.skip_plot:
            ...
            plot_args = argparse.Namespace(
                ...
                linear_layout=getattr(args, "linear_layout", "two-column"),
                publication_journal=getattr(args, "publication_journal", "nature"),
                panel_label=getattr(args, "panel_label", None),
                terminal_details=getattr(args, "terminal_details", False),
                variant_sites=getattr(args, "variant_sites", None),
                variant_min_base_quality=getattr(args, "variant_min_base_quality", 20),
